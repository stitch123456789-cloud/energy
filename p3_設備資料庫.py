...
with c4:
    tp_s = st.number_input("夏溫", min_value=0.0, value=7.0, step=0.1, key="tp_s")
    tp_sp = st.number_input("春溫", min_value=0.0, value=7.0, step=0.1, key="tp_sp")
    tp_w = st.number_input("冬溫", min_value=0.0, value=7.0, step=0.1, key="tp_w")
